<template>
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            <isotope ref="cpt" id="root_isotope1" :item-selector="'element-item'" :list="listaRepuestos"
                     :options='option' @filter="filterOption=arguments[0]" @sort="sortOption=arguments[0]"
...
<script>
    ...
    export default {
        ...
        computed: {
            listaRepuestos() {
                return this.$store.state.listaRepuestos;
            }
