...
import cesar.cabrera.config.audit.AuditEventConverter;
import cesar.cabrera.domain.PersistentAuditEvent;
...
import static cesar.cabrera.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
